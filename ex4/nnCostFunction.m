...
%calculate hidden layer activation function
z2 = a1 * Theta1';
a2 = sigmoid(z2);

%append bias to hidden layer
a2 = [ones(size(a2,1), 1) a2];

%calculate the output layer activation function
z3 = a2 * Theta2';
a3 = sigmoid(z3);
...
% 
% J = J / m;
% yvec size = m x num_labels
% hThetaX size = m x num_labels
% J size = m x num_labels
